...
$sql = "INSERT INTO formdata (user_name,password,emp_number,website,gender,movie1,movie2,movie3) VALUES ('$name','$pass', '$emp' ,'$web' ,'$gen' ,'$mov1','$mov2','$mov3' ) ";
...
$sql="SELECT web FROM websitename";
...
if($result->num_rows>0){
	while($rows=$result->fetch_assoc()){
		...
		echo '<option value="'  .$rows["web"]  .'">'.$rows["web"].'</option>';		
		}	
